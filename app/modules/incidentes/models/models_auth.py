...
class Persona(Base):
    ...
    ci = Column(String(20), nullable=False, default="")
    nombres = Column(String(50), nullable=False, default="")
    apellido_paterno = Column(String(50), nullable=False, default="")
    apellido_materno = Column(String(50), nullable=False, default="")
